...
exports.createFilterObj = (req, res, next) => {
  //putting my filterobj(clientid in my req.params) if provided in my request so that i can do my query on it
  //to get the chainOftasks for my client
  let filterObject = {};
...
exports.getAllUsers = asyncHandler(async (req, res) => {
  ...
  const users = await UserModel.find(req.filterObject).skip(skip).limit(limit);
